...
public class PropertyController {
    ...
    public ApiResponse<List<PropertyResponse>> filterProperties(
        @RequestParam(required = false) Long provinceId,
        @RequestParam(required = false) Long districtId,
        @RequestParam(required = false) Long communeId
        ) {
    
        List<PropertyResponse> filteredProperties = propertyService.filterProperties(provinceId, districtId, communeId);
